...
import '../media/styles/showThumbUpDetail.less';

class ShowThumbUpDetail extends Component{
    constructor(props){
        super(props);
        this.state = {
            rankingInfo: [],
    ...
    render(){
        ...
        return (
            <div className='showAnswer showThumb-bg'>
...
export default connect(mapStateToProps)(ShowThumbUpDetail);
