...
public class RechargeUtil {
    private static String apiKey = Constants.PROPERTIES.getProperty("ihuyi.api.key");
    ...
    public static void reCharge(String phone, Integer price, String orderId) {
        try {
            ...
            nvps.add(new BasicNameValuePair("username", apiId));
    ...
    public static String getSign(String phone, String orderId, Integer price, String timestamp) throws NoSuchAlgorithmException, UnsupportedEncodingException {
