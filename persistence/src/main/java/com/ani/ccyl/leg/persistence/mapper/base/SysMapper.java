package com.ani.ccyl.leg.persistence.mapper.base;
...
public interface SysMapper<T> {
    ...
    int deleteByIDS(@Param("ids") Object[] key) throws PersistenceException;
     ...
     */
    @InsertProvider(type = SysMapperProvider.class, method = "dynamicSQL")
    int insertSelective(T record) throws PersistenceException;
     ...
     */
    @DeleteProvider(type = SysMapperProvider.class, method = "dynamicSQL")
    int delete(T key) throws PersistenceException;
    ...
    int updateByPrimaryKey(T record) throws PersistenceException;
     ...
     */
    @UpdateProvider(type = SysMapperProvider.class, method = "dynamicSQL")
    int updateByPrimaryKeySelective(T record) throws PersistenceException;
