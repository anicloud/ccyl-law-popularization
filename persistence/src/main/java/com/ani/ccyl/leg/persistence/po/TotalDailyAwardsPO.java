 ...
 */
@Table(name = "t_total_daily_awards")
public class TotalDailyAwardsPO implements Serializable {
    ...
    public TotalDailyAwardsPO() {
    }

    public TotalDailyAwardsPO(Integer id, String prodId, String codeSecret, AwardTypeEnum type, Timestamp updateTime, Timestamp createTime, Boolean isDel) {
        this.id = id;
        this.prodId = prodId;
